...
### Step 1:
Create a folder named ex06.Clone your git repository in this folder and change the directory as "cover-page-design". Create myproj inside it. Then create myapp and make the necessary changes.
...
<html lang="en">
    <head>
        ...
        .bookpage{
            ...
            background-image: url(/static/images/bookk.jpg);
    ...
    <body>
        <div class="bookpage">
            ...
            <div class="photo">
                <img src="/static/images/Manojkarthik1.jpg" width="130" height="145" alt="">
            </div>
            <div class="id">
                <hr style="color: orange;">
            </div>
            <div class="author">
               <p><b>MANOJ KARTHIK R</b></p>
            </div>
            <div class="publisher">
                Packt>
            </div>
